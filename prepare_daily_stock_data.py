...
from utils.yfinance_fetcher import (
...
def upload_to_s3_daily_data(csv_file_path: str) -> None:
    ...
    try:
        ...
        print("   Make sure your .env file has correct AWS credentials and S3_BUCKET_NAME")
...
def query_stock_data(ticker: str, start_date: str, end_date: str = None) -> pd.DataFrame:
    """
...
def query_multiple_stocks(tickers: list, start_date: str, end_date: str = None) -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    if not df.empty:
        ...
        print("S3 Upload:")
        print("=" * 60)
        print("To automatically upload to S3, set upload_to_s3=True in prepare_daily_stock_data()")
        print("Or manually upload using:")
        print(f"    from prepare_daily_stock_data import upload_to_s3_daily_data")
        output_filename = output_file if 'output_file' in locals() else 'daily_stock_data_YYYY-MM-DD.csv'
