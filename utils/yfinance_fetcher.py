...
def create_daily_performance_dataset(
    ...
    if all_info:
        ...
        combined_data = combined_data.merge(
            info_df[['Ticker', 'Company Name', 'Sector', 'Industry', 'Market Cap', 'EPS', 'Revenue', 
                     'Revenue Growth', 'PE Ratio', 'Free Cash Flow', 'ROE', 'Beta']],
            on='Ticker',
            how='left'
        )
    ...
    combined_data['Price Change %'] = combined_data['Price Change'] / combined_data['Close'].shift(1) * 100
