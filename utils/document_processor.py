...
def extract_metadata(filename: str) -> Dict[str, Optional[str]]:
    ...
    # Extract ticker from filings path (e.g., "data/fillings/AAPL/2024-11-01-10k-AAPL.html")
...
def format_document_summary(metadata: Dict, preview: str = None, max_preview: int = 500) -> str:
    ...
    if preview:
        preview_text = preview[:max_preview] + "..." if len(preview) > max_preview else preview
        lines.append(f"\n**Preview:**\n{preview_text}")
